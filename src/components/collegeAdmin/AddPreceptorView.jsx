...
export const AddPreceptorView = ({ college, onCancel, onSuccess }) => {
  ...
  const username = formData.email ? formData.email.trim() : '';
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    const res = await insertPreceptorToSupabase(college.id, formData);
    setSaving(false);
    ...
    if (res.success) {
      ...
      setFormError(res.error || 'Failed to save preceptor to database.');
    }
  };
    ...
    <div className="space-y-6 animate-fadeIn max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800">
        <div>
          <h2 className="text-xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
            ...
            <span>Add New Clinical Preceptor</span>
          </h2>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Register hospital doctors & clinical evaluators for <strong className="text-slate-800 dark:text-slate-200">{college?.name}</strong>.
          </p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {/* LEFT 8 COLS: PERSONAL & PROFESSIONAL INFO */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                disabled
                value={username}
                placeholder="Populates from Email Address"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Enter preceptor password"
