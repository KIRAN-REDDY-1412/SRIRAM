...
import { UserCheck, KeyRound, Eye, EyeOff, LogIn, AlertTriangle, Loader2 } from 'lucide-react';
  ...
  return (
    <>
      <ModalWrapper
        ...
        subtitle={`Pharm.D Logbook Login for ${initialCollege?.name || 'Pharmacy College'}`}
        maxWidth="max-w-md"
      >
        ...
        <div className="pt-2 flex items-center justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={loggingIn}
            className="px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-md shadow-emerald-600/20 disabled:opacity-50 flex items-center gap-1.5"
          >
            {loggingIn ? (
              <>
